...
from tasks.enums import ContentTypes
...
@app.task
def start_video_processing(video: bytes, task_id: str) -> List[list]:
    cfg = get_cfg()
    ...
    TaskProccesingOrchestrator.end(ContentTypes.MP4, task_id)
